...
namespace Calculos
{
    internal class Program
    {
        static void Main(string[] args)
        {
			...
			double t1 = Conversoes.ConverterTemperatura(Conversoes.ConverterTemperatura.CelsiusFahrenheit, 36);
			double t2 = Conversoes.ConverterTemperatura(Conversoes.ConverterTemperatura.FahrenheitCelsius, 100);
